...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="webjars/smalot-bootstrap-datetimepicker/2.3.8/css/bootstrap-datetimepicker.css"/>
    <%--<link rel="stylesheet" type="text/css" href="webjars/datetimepicker/2.4.5/jquery.datetimepicker.css"/>--%>
    ...
    <script src="webjars/smalot-bootstrap-datetimepicker/2.3.8/js/bootstrap-datetimepicker.js" defer></script>
    <%--<script src="webjars/datetimepicker/2.4.5/jquery.datetimepicker.js" defer></script>--%>
</head>